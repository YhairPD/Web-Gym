...
@Component({
  selector: 'agregar-sucursal',
  templateUrl: 'agregar.template.html'
})
export class AgregarSucursalComponent implements OnDestroy, OnInit  {
  ...
  public agregar(){
    swal({
        title: "¿ Estas seguro ?",
        text: "¡ Estas apunto de agregar una sucursal !",
        type: "warning",
        showCancelButton: true,
        cancelButtonText: "Cancelar",
        confirmButtonColor: "#5de265",
        confirmButtonText: "Si, agregarla!",
        closeOnConfirm: true
    }, function () {
